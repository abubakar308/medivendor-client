...
const Aboutus = () => {
    return (
        ...
        <div className="py-16 text-center px-4">
          <h1 className="text-4xl md:text-3xl text-secondary font-bold mb-4">About MediVendor</h1>
        ...
        <div className="py-16 px-4 max-w-6xl mx-auto grid md:grid-cols-2 gap-10 items-center">
          <img
            src="https://source.unsplash.com/600x400/?medical,equipment"
            alt="mission"
        ...
        <div className="py-16 px-4 max-w-6xl mx-auto">
          ...
          <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-8 text-center">
            {[
              { name: "Abubakar Siddique", role: "Founder & Lead Developer", img: "https://source.unsplash.com/200x200/?person,developer" },
              { name: "Sadia Rahman", role: "Product Manager", img: "https://source.unsplash.com/200x200/?woman,healthcare" },
              { name: "Tariq Hossain", role: "Operations & Support", img: "https://source.unsplash.com/200x200/?man,tech" },
            ].map((person, i) => (
